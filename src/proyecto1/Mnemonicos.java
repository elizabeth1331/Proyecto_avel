...
public class Mnemonicos {
    ...
    public void insertar(){
        ...
        Extendido.put("LDAA","B6");
        Extendido.put("LDAB","F6");
        Extendido.put("LDD","FC");
        Extendido.put("LDS","BE");
        Extendido.put("LDX","FE");
        Extendido.put("LDY","18FE");
        ...
        BytesDirecto.put("LDAA",1);
        BytesDirecto.put("LDAB",1);
        BytesDirecto.put("LDD",1);
        BytesDirecto.put("LDS",1);
        BytesDirecto.put("LDX",1);
        BytesDirecto.put("LDY",1);
        ...
        BytesExtendido.put("LDAA",2);
        BytesExtendido.put("LDAB",2);
        BytesExtendido.put("LDD",2);
        BytesExtendido.put("LDS",2);
        BytesExtendido.put("LDX",2);
