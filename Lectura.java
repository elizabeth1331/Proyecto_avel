...
public class Lectura extends javax.swing.JFrame {
    ...
    private void selectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectActionPerformed
        ...
        if(seleccionado.showDialog(null, "ABRIR ARCHIVO")== JFileChooser.APPROVE_OPTION){
          ...
          if(archivo.canRead()){
            if(archivo.getName().endsWith("ASC")||archivo.getName().endsWith("asc")||archivo.getName().endsWith("TXT")||archivo.getName().endsWith("txt")||archivo.getName().endsWith("lst")||archivo.getName().endsWith("LST")||archivo.getName().endsWith("s19")||archivo.getName().endsWith("S19")){
